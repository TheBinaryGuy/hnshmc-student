            ...
            <SelectPrimitive.Overlay
                ...
                <Animated.View entering={FadeIn} exiting={FadeOut}>
                    <SelectPrimitive.Content
                        ref={ref}
                        className={cn(
                            'relative z-50 max-h-96 min-w-32 rounded-md border border-border bg-popover px-1 py-2 shadow-md shadow-foreground/10 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
                            position === 'popper' &&
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        {...props}>
        <View className='native:left-3.5 native:pt-px absolute left-2 flex size-3.5 items-center justify-center'>
